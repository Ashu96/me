...
const IndexPage = () => (
  <Layout>
    <SEO title="Home" />
    <div className="w-full h-screen p-10 md:px-16 bg-black">
        ...
        <div className="w-full md:w-1/2 py-2 md:px-4">
          ...
          <div>
            <ul className='flex ml-0'>
              <li className='px-4'>
                <a className='text-white hover:text-purple-400 border-b border-white hover:border-purple-700' href="https://github.com/ashu96">Github</a>
              </li>
              <li className='px-4'>
                <a className='text-white hover:text-purple-400 border-b border-white hover:border-purple-700' href="https://github.com/ashu96">LinkedIn</a>
              </li>
            </ul>
          </div>
        </div>
